...
public class CrearReporteMicroCurriculoCtl extends GenericForwardComposer implements ListitemRenderer {

	private static Logger logger=Logger.getLogger(CrearReporteMicroCurriculoCtl.class);
	...
	public void doAfterCompose(Component comp)throws Exception {
		...
		logger.info("cargando ventana generar reporte micro curriculo");
	}
	...
	public void onClick$btnReporte(Event event) throws Exception {
		...
		parametros.put("IdMicroCurriculoParam", lblnbMicIdn.getValue());
