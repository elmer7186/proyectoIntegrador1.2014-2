...
public class CrearReporteXEstadoCtl extends GenericForwardComposer implements ListitemRenderer {

	private static Logger logger=Logger.getLogger(CrearReporteXEstadoCtl.class);
	...
	public void doAfterCompose(Component comp)throws Exception {
		...
		logger.info("cargando ventana generar reporte por estado del micro curriculo");
	}
	...
	public void onClick$btnReporte(Event event){
		...
		parametros.put("IdMicroCurriculoParam", lblnbEstIdn.getValue());
